...
async function createLocalization(contentType: string, documentId: string, locale: string, data: Record<string, unknown>) {
  try {
    ...
    const result = await apiRequest(`${contentType}/${documentId}?locale=${locale}`, {
      method: 'PUT',
      body: JSON.stringify({ data }),
    });
...
const serviceItems = [
  ...
  { title: 'Brand & Advertising Campaigns', title_vi: 'Chiến Dịch Thương Hiệu & Quảng Cáo', description: 'We produce fashion, lifestyle, editorial, social media, and influencer campaigns that bring brands to life with fresh creative energy.', description_vi: 'Chúng tôi sản xuất các chiến dịch thời trang, phong cách sống, biên tập, mạng xã hội và influencer mang đến sức sống mới cho thương hiệu.', page: 'creative', section: 'services', order: 1 },
  { title: 'Product & Packaging Shoots', title_vi: 'Chụp Sản Phẩm & Bao Bì', description: 'From product labels and e-commerce images to packshots and still life, we create polished visuals that elevate packaging, catalogs, and online stores.', description_vi: 'Từ nhãn sản phẩm và hình ảnh thương mại điện tử đến packshot và tĩnh vật, chúng tôi tạo ra hình ảnh chất lượng cho bao bì, catalog và cửa hàng trực tuyến.', page: 'creative', section: 'services', order: 2 },
  // Creative page - workflow
  { title: 'Creative Direction', title_vi: 'Định Hướng Sáng Tạo', description: 'We study your brief and develop creative directions based on your brand, audience, and goals.', description_vi: 'Chúng tôi nghiên cứu brief và phát triển định hướng sáng tạo dựa trên thương hiệu, đối tượng và mục tiêu của bạn.', counter: '01.', page: 'creative', section: 'workflow', order: 1 },
  { title: 'Storyboard Development', title_vi: 'Phát Triển Storyboard', description: 'Our team creates detailed storyboards and shot lists to visualize the final output.', description_vi: 'Đội ngũ của chúng tôi tạo storyboard chi tiết và danh sách cảnh quay để hình dung sản phẩm cuối cùng.', counter: '02.', page: 'creative', section: 'workflow', order: 2 },
  { title: 'Pre-production & Sourcing', title_vi: 'Tiền Sản Xuất & Chuẩn Bị', description: 'We coordinate talent, locations, props, and equipment to ensure smooth execution.', description_vi: 'Chúng tôi phối hợp nhân sự, địa điểm, đạo cụ và thiết bị để đảm bảo thực hiện suôn sẻ.', counter: '03.', page: 'creative', section: 'workflow', order: 3 },
  { title: 'Shoot / Production', title_vi: 'Chụp / Sản Xuất', description: 'Our experienced crew captures your vision with precision and creative flair.', description_vi: 'Đội ngũ giàu kinh nghiệm của chúng tôi ghi lại tầm nhìn của bạn với độ chính xác và phong cách sáng tạo.', counter: '04.', page: 'creative', section: 'workflow', order: 4 },
  { title: 'Post-production', title_vi: 'Hậu Kỳ', description: 'Professional editing, color grading, and retouching bring the final deliverables to life.', description_vi: 'Chỉnh sửa chuyên nghiệp, chỉnh màu và retouch mang sản phẩm cuối cùng thành hiện thực.', counter: '05.', page: 'creative', section: 'workflow', order: 5 },
  { title: 'Final Delivery', title_vi: 'Bàn Giao', description: 'We deliver polished assets ready for print, digital, and social media deployment.', description_vi: 'Chúng tôi bàn giao sản phẩm hoàn chỉnh sẵn sàng cho in ấn, kỹ thuật số và mạng xã hội.', counter: '06.', page: 'creative', section: 'workflow', order: 6 },

  // Production page - services
  { title: 'Campaign & Editorial Production', title_vi: 'Sản Xuất Chiến Dịch & Editorial', description: 'We curate bespoke campaigns and editorials that blend artistry, narrative, and timeless sophistication — bringing each brand story to life with cinematic allure.', description_vi: 'Chúng tôi tạo ra các chiến dịch và editorial riêng biệt kết hợp nghệ thuật, câu chuyện và sự tinh tế vượt thời gian — mang từng câu chuyện thương hiệu sống động với sức hút điện ảnh.', page: 'production', section: 'services', order: 1 },
  { title: 'Photography & Film Production', title_vi: 'Sản Xuất Nhiếp Ảnh & Phim', description: 'From concept to final cut, we deliver high-impact visuals through expert direction, seamless coordination, and creative storytelling.', description_vi: 'Từ concept đến bản cắt cuối, chúng tôi cung cấp hình ảnh có tác động cao thông qua chỉ đạo chuyên nghiệp, phối hợp liền mạch và kể chuyện sáng tạo.', page: 'production', section: 'services', order: 2 },
  { title: 'Lighting & Equipment Rental', title_vi: 'Cho Thuê Ánh Sáng & Thiết Bị', description: 'Premium lighting and state-of-the-art equipment designed to elevate every production with precision, balance, and creative control.', description_vi: 'Ánh sáng cao cấp và thiết bị hiện đại được thiết kế để nâng tầm mọi sản xuất với độ chính xác, cân bằng và kiểm soát sáng tạo.', page: 'production', section: 'services', order: 3 },
  { title: 'Make-up & Hair Stylist', title_vi: 'Trang Điểm & Làm Tóc', description: 'Professional beauty services that transform talent and enhance visual storytelling with meticulous attention to detail.', description_vi: 'Dịch vụ làm đẹp chuyên nghiệp biến đổi nhân sự và nâng cao kể chuyện hình ảnh với sự chú ý tỉ mỉ đến từng chi tiết.', page: 'production', section: 'services', order: 4 },
  { title: 'Location Scouting & Permits', title_vi: 'Khảo Sát Địa Điểm & Giấy Phép', description: 'We source the perfect locations and handle all permit logistics, ensuring smooth operations from pre-production to wrap.', description_vi: 'Chúng tôi tìm kiếm địa điểm hoàn hảo và xử lý tất cả thủ tục giấy phép, đảm bảo hoạt động suôn sẻ từ tiền sản xuất đến kết thúc.', page: 'production', section: 'services', order: 5 },
  { title: 'Post-production Coordination', title_vi: 'Điều Phối Hậu Kỳ', description: 'End-to-end post-production management, from editing and color grading to final delivery across all formats.', description_vi: 'Quản lý hậu kỳ toàn diện, từ chỉnh sửa và chỉnh màu đến bàn giao cuối cùng trên tất cả các định dạng.', page: 'production', section: 'services', order: 6 },
  // Production page - workflow
  { title: 'Pre-Production', title_vi: 'Tiền Sản Xuất', description: 'Concept, scheduling, and creative', description_vi: 'Concept, lịch trình và sáng tạo', counter: '01.', page: 'production', section: 'workflow', order: 1 },
  { title: 'Set-Up', title_vi: 'Chuẩn Bị', description: 'Lighting, camera, art direction', description_vi: 'Ánh sáng, máy quay, chỉ đạo nghệ thuật', counter: '02.', page: 'production', section: 'workflow', order: 2 },
  { title: 'Shoot Day', title_vi: 'Ngày Quay', description: 'Execution and real-time adjustments', description_vi: 'Thực hiện và điều chỉnh thời gian thực', counter: '03.', page: 'production', section: 'workflow', order: 3 },
  { title: 'Wrap & Delivery', title_vi: 'Kết Thúc & Bàn Giao', description: 'Editing, review, and delivery', description_vi: 'Chỉnh sửa, đánh giá và bàn giao', counter: '04.', page: 'production', section: 'workflow', order: 4 },

  // Set Design page - workflow
  { title: 'Brief & Concept Alignment', title_vi: 'Hiểu Brief & Định Hướng Concept', description: 'We start by understanding your creative direction, brand language, and spatial needs.', description_vi: 'Chúng tôi bắt đầu bằng việc hiểu định hướng sáng tạo, ngôn ngữ thương hiệu và nhu cầu không gian của bạn.', counter: '01.', page: 'set-design', section: 'workflow', order: 1 },
  { title: '2D Layout & 3D Render', title_vi: 'Bản Vẽ 2D & Render 3D', description: 'We create technical layouts and 3D visuals that bring the proposed set design to life — before anything is built.', description_vi: 'Chúng tôi tạo bản vẽ kỹ thuật và hình ảnh 3D mang thiết kế bối cảnh đề xuất thành hiện thực — trước khi bất cứ thứ gì được xây dựng.', counter: '02.', page: 'set-design', section: 'workflow', order: 2 },
  { title: 'Presentation & Feedback Loop', title_vi: 'Trình Bày & Phản Hồi', description: "We present the design and collaborate closely with your team to refine it until it's approved.", description_vi: 'Chúng tôi trình bày thiết kế và hợp tác chặt chẽ với đội ngũ của bạn để hoàn thiện cho đến khi được phê duyệt.', counter: '03.', page: 'set-design', section: 'workflow', order: 3 },
  { title: 'Set Construction & Sourcing', title_vi: 'Xây Dựng & Chuẩn Bị Bối Cảnh', description: 'We build the set and source all backdrops, structural elements, props, and textures to match the approved concept.', description_vi: 'Chúng tôi xây dựng bối cảnh và chuẩn bị tất cả phông nền, yếu tố cấu trúc, đạo cụ và kết cấu phù hợp với concept đã duyệt.', counter: '04.', page: 'set-design', section: 'workflow', order: 4 },
  { title: 'Setup & Shoot Support', title_vi: 'Chuẩn Bị & Hỗ Trợ Quay', description: 'We handle set assembly, stay present during the shoot to make real-time adjustments, and ensure everything works on camera.', description_vi: 'Chúng tôi xử lý lắp đặt bối cảnh, có mặt trong suốt buổi quay để điều chỉnh thời gian thực và đảm bảo mọi thứ hoạt động trên camera.', counter: '05.', page: 'set-design', section: 'workflow', order: 5 },
  { title: 'Set Maintenance & Tear-Down', title_vi: 'Bảo Trì & Tháo Dỡ Bối Cảnh', description: 'Once the shoot wraps, we handle cleanup and dismantle the set efficiently and professionally.', description_vi: 'Khi buổi quay kết thúc, chúng tôi xử lý dọn dẹp và tháo dỡ bối cảnh một cách hiệu quả và chuyên nghiệp.', counter: '06.', page: 'set-design', section: 'workflow', order: 6 },

  // Event Planning page - services
  { title: 'Product & Brand Launches', title_vi: 'Ra Mắt Sản Phẩm & Thương Hiệu', description: 'We craft launch experiences that captivate audiences and elevate your brand story with precision and flair.', description_vi: 'Chúng tôi tạo ra trải nghiệm ra mắt thu hút khán giả và nâng tầm câu chuyện thương hiệu với độ chính xác và phong cách.', page: 'event-planning', section: 'services', order: 1 },
  { title: 'Fashion Shows', title_vi: 'Trình Diễn Thời Trang', description: 'From runway to backstage, we design and execute fashion events that celebrate artistry and style.', description_vi: 'Từ sàn diễn đến hậu trường, chúng tôi thiết kế và thực hiện các sự kiện thời trang tôn vinh nghệ thuật và phong cách.', page: 'event-planning', section: 'services', order: 2 },
  { title: 'Private Dinners', title_vi: 'Tiệc Riêng Tư', description: 'Intimate gatherings curated with exquisite detail, creating memorable moments for your guests.', description_vi: 'Các buổi họp mặt thân mật được tổ chức với chi tiết tinh tế, tạo ra những khoảnh khắc đáng nhớ cho khách của bạn.', page: 'event-planning', section: 'services', order: 3 },
  { title: 'Art & Lifestyle Pop-Ups', title_vi: 'Pop-Up Nghệ Thuật & Phong Cách Sống', description: 'Immersive pop-up experiences that blend art, culture, and lifestyle into unforgettable activations.', description_vi: 'Trải nghiệm pop-up đắm chìm kết hợp nghệ thuật, văn hóa và phong cách sống thành các hoạt động khó quên.', page: 'event-planning', section: 'services', order: 4 },
  { title: 'Press & Influencer Events', title_vi: 'Sự Kiện Báo Chí & Influencer', description: 'Strategic media events designed to generate buzz and build lasting connections with key voices.', description_vi: 'Sự kiện truyền thông chiến lược được thiết kế để tạo tiếng vang và xây dựng kết nối lâu dài với các tiếng nói quan trọng.', page: 'event-planning', section: 'services', order: 5 },
  { title: 'Corporate Celebrations', title_vi: 'Lễ Kỷ Niệm Doanh Nghiệp', description: "Professional yet refined corporate events that reflect your company's values and vision.", description_vi: 'Sự kiện doanh nghiệp chuyên nghiệp nhưng tinh tế phản ánh giá trị và tầm nhìn của công ty bạn.', page: 'event-planning', section: 'services', order: 6 },
  // Event Planning page - workflow
  { title: 'Full Creative & Design Direction', title_vi: 'Chỉ Đạo Sáng Tạo & Thiết Kế Toàn Diện', description: "From concept to creation, Saint 6 shapes a cohesive visual story that embodies your brand's vision.", description_vi: 'Từ concept đến sáng tạo, Saint 6 định hình câu chuyện hình ảnh gắn kết thể hiện tầm nhìn thương hiệu của bạn.', counter: '01.', page: 'event-planning', section: 'workflow', order: 1 },
  { title: 'Guest Experience & Flow Planning', title_vi: 'Trải Nghiệm Khách & Lập Kế Hoạch Luồng', description: 'Every moment is designed with intention — seamless, elegant, and unforgettable.', description_vi: 'Mỗi khoảnh khắc được thiết kế có chủ đích — liền mạch, thanh lịch và khó quên.', counter: '02.', page: 'event-planning', section: 'workflow', order: 2 },
  { title: 'On-site Management & Run-of-Show Execution', title_vi: 'Quản Lý Tại Chỗ & Thực Hiện Chương Trình', description: 'Flawless coordination ensures your event unfolds with effortless precision.', description_vi: 'Phối hợp hoàn hảo đảm bảo sự kiện của bạn diễn ra với độ chính xác dễ dàng.', counter: '03.', page: 'event-planning', section: 'workflow', order: 3 },
  { title: 'Venue Styling & Set Design', title_vi: 'Trang Trí Địa Điểm & Thiết Kế Bối Cảnh', description: 'We craft immersive environments that capture emotion, detail, and distinctive character.', description_vi: 'Chúng tôi tạo ra môi trường đắm chìm nắm bắt cảm xúc, chi tiết và tính cách đặc biệt.', counter: '04.', page: 'event-planning', section: 'workflow', order: 4 },
  { title: 'Catering & Entertainment Coordination', title_vi: 'Điều Phối Ẩm Thực & Giải Trí', description: 'We curate dining and performances that enrich the mood and elevate the experience.', description_vi: 'Chúng tôi tuyển chọn ẩm thực và biểu diễn làm phong phú không khí và nâng tầm trải nghiệm.', counter: '05.', page: 'event-planning', section: 'workflow', order: 5 },

  // Decor page - workflow
  { title: 'Brief Overview', title_vi: 'Tổng Quan Brief', description: 'We study the brief and develop multiple creative directions based on your brand, audience, and goals.', description_vi: 'Chúng tôi nghiên cứu brief và phát triển nhiều hướng sáng tạo dựa trên thương hiệu, đối tượng và mục tiêu của bạn.', counter: '01.', page: 'decor', section: 'workflow', order: 1 },
  { title: '2D Ideation', title_vi: 'Ý Tưởng 2D', description: 'Our design team creates detailed mood boards and conceptual layouts to visualize the space transformation.', description_vi: 'Đội ngũ thiết kế của chúng tôi tạo mood board chi tiết và bố cục khái niệm để hình dung sự chuyển đổi không gian.', counter: '02.', page: 'decor', section: 'workflow', order: 2 },
  { title: '3D Render', title_vi: 'Render 3D', description: 'We produce photorealistic 3D renders so you can experience the space before construction begins.', description_vi: 'Chúng tôi tạo ra render 3D thực tế để bạn có thể trải nghiệm không gian trước khi xây dựng bắt đầu.', counter: '03.', page: 'decor', section: 'workflow', order: 3 },
  { title: 'Pre-Production', title_vi: 'Tiền Sản Xuất', description: 'We coordinate materials, vendors, and timelines to ensure smooth execution of your project.', description_vi: 'Chúng tôi phối hợp vật liệu, nhà cung cấp và lịch trình để đảm bảo thực hiện dự án suôn sẻ.', counter: '04.', page: 'decor', section: 'workflow', order: 4 },
  { title: 'Final Installation', title_vi: 'Lắp Đặt Hoàn Thiện', description: 'Our team manages the complete installation, bringing every detail to life with precision.', description_vi: 'Đội ngũ của chúng tôi quản lý việc lắp đặt hoàn chỉnh, đưa từng chi tiết vào cuộc sống với độ chính xác.', counter: '05.', page: 'decor', section: 'workflow', order: 5 },
];
