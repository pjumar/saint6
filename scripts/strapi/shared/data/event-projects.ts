...
export const eventProjects: EventProjectSeedData[] = [
  {
    ...
    images: [
      "/images/event-planning/gallery-1.jpg",
      "/images/event-planning/gallery-2.jpg",
      "/images/event-planning/portfolio-1.jpg",
    ],
    order: 1,
  },
  {
    ...
    images: [
      "/images/event-planning/gallery-3.jpg",
      "/images/event-planning/gallery-4.jpg",
      "/images/event-planning/portfolio-2.jpg",
      "/images/event-planning/portfolio-3.jpg",
    ],
    order: 2,
  },
  {
    ...
    images: [
      "/images/event-planning/portfolio-4.jpg",
      "/images/event-planning/portfolio-5.jpg",
    ],
    order: 3,
  },
  {
    ...
    images: [
      "/images/event-planning/service-corporate.jpg",
      "/images/event-planning/service-press-events.jpg",
      "/images/event-planning/service-product-launches.jpg",
    ],
    order: 4,
  },
];
