...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    full_width_image: Schema.Attribute.Media<'images'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    >;
    mission: Schema.Attribute.Component<'about.highlight-band', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    our_story: Schema.Attribute.Component<'about.story', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    vision: Schema.Attribute.Component<'about.highlight-band', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiBrandLogoBrandLogo extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Trusted brands/clients logos';
...
export interface ApiCreativePageCreativePage extends Struct.SingleTypeSchema {
  collectionName: 'creative_pages';
  info: {
    description: 'Creative services page content';
    displayName: 'Creative Page';
    pluralName: 'creative-pages';
    singularName: 'creative-page';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    client_logos: Schema.Attribute.Relation<
      ...
      'api::brand-logo.brand-logo'
    >;
    clients: Schema.Attribute.Component<'shared.clients-section', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::creative-page.creative-page'
    >;
...
export interface ApiDecorPageDecorPage extends Struct.SingleTypeSchema {
  collectionName: 'decor_pages';
  info: {
    description: 'Decoration services page content';
    displayName: 'Decor Page';
    pluralName: 'decor-pages';
    singularName: 'decor-page';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    intro_2: Schema.Attribute.Component<'shared.intro', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiEquipmentItemEquipmentItem
  ...
  info: {
    description: 'Lighting and equipment for rental';
...
export interface ApiEventPlanningPageEventPlanningPage
  extends Struct.SingleTypeSchema {
  collectionName: 'event_planning_pages';
  info: {
    description: 'Event planning services page content';
    displayName: 'Event Planning Page';
    pluralName: 'event-planning-pages';
    singularName: 'event-planning-page';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::event-planning-page.event-planning-page'
    >;
    publishedAt: Schema.Attribute.DateTime;
    services: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    crew_area: Schema.Attribute.Component<'homepage.crew-area', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    gallery_images: Schema.Attribute.Component<'shared.gallery-image', true>;
    hero: Schema.Attribute.Component<'shared.hero', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    key_projects: Schema.Attribute.Relation<
      'oneToMany',
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    space_section: Schema.Attribute.Component<'homepage.space-section', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    trusted_heading: Schema.Attribute.Text &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    trusted_tagline: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiKeyProjectKeyProject extends Struct.CollectionTypeSchema {
  collectionName: 'key_projects';
  info: {
    description: 'Featured key projects for homepage showcase';
    displayName: 'Key Project';
    pluralName: 'key-projects';
    singularName: 'key-project';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiPortfolioItemPortfolioItem
  ...
  attributes: {
    ...
    order: Schema.Attribute.Integer &
      ...
      Schema.Attribute.DefaultTo<0>;
    page: Schema.Attribute.Enumeration<['creative', 'set-design', 'decor']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiProductionPageProductionPage
  ...
  info: {
    description: 'Production services page content';
    displayName: 'Production Page';
...
export interface ApiServiceItemServiceItem extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Reusable service and workflow items';
  ...
  attributes: {
    ...
    page: Schema.Attribute.Enumeration<
      ['creative', 'production', 'set-design', 'event-planning', 'decor']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
    ...
    publishedAt: Schema.Attribute.DateTime;
    section: Schema.Attribute.Enumeration<['services', 'workflow']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiSetDesignPageSetDesignPage extends Struct.SingleTypeSchema {
  collectionName: 'set_design_pages';
  info: {
    description: 'Set design services page content';
    displayName: 'Set Design Page';
    pluralName: 'set-design-pages';
    singularName: 'set-design-page';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiSocialLinkSocialLink extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    facebook_label: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    tiktok_label: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiStudioRentalPageStudioRentalPage
  ...
  info: {
    description: 'Studio rental page content';
    displayName: 'Studio Rental Page';
    pluralName: 'studio-rental-pages';
    singularName: 'studio-rental-page';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    concept_rooms: Schema.Attribute.Relation<
      'oneToMany',
    ...
    equipment: Schema.Attribute.Relation<
      ...
      'api::equipment-item.equipment-item'
    >;
    facilities: Schema.Attribute.Component<'studio.facilities', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    full_rental: Schema.Attribute.Component<'studio.full-rental', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    rooms: Schema.Attribute.Relation<
      ...
      'api::studio-room.studio-room'
    >;
    stats: Schema.Attribute.Component<'studio.stats', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiStudioRoomStudioRoom extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Studio rooms available for rental';
  ...
  attributes: {
    ...
    order: Schema.Attribute.Integer &
      ...
      Schema.Attribute.DefaultTo<0>;
    price_per_hour: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
    ...
    type: Schema.Attribute.Enumeration<['blank', 'concept']> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
      }> &
      Schema.Attribute.DefaultTo<'blank'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiTestimonialItemTestimonialItem
  ...
  info: {
    description: 'Client testimonial with brand info';
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::creative-page.creative-page': ApiCreativePageCreativePage;
